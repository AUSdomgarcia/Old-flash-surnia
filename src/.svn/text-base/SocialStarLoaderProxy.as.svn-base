package
{
	...
	public class SocialStarLoaderProxy extends MovieClip
	{
		...
		public function SocialStarLoaderProxy()
		{
			// Security initialize
			...
			Security.allowDomain("http://1.234.2.179/socialstardev/offices/questlist");			
			Security.allowDomain("http://1.234.2.179/socialstardev");
		...
		private function onEnterFrame(ev:Event):void{
			if (framesLoaded == totalFrames){
				...
				TweenLite.to(_loaderMC.preloaderBar.loaderBar, .2, {scaleX:root.loaderInfo.bytesLoaded/root.loaderInfo.bytesTotal});
		...
		private function init():void {			
			...
			removeListeners();
			var mainClass:Class = Class(getDefinitionByName("SocialStarProxy"));
			if(mainClass){
