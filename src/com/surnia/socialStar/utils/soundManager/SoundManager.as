package com.surnia.socialStar.utils.soundManager 
{		
	import com.surnia.socialStar.utils.soundManager.config.SoundManagerConfig;
	import com.surnia.socialStar.utils.soundManager.events.SoundManagerEvent;
	...
	public class SoundManager extends EventDispatcher
	{
		...
		// to do in the future make a config where for every sounds 
		// make the sound manager load externally online
		/*-------------------------------------------------------------------Constant---------------------------------------------------------------------*/
