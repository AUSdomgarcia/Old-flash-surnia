...
{	
	 ...
	 */
	public class ImageAssetLoader extends Sprite
	{
		/*-------------------------------------------------------------------------Constant-----------------------------------------------------------------*/
		...
		public function loadImage( url:String,live:Boolean, isFBImage:Boolean = false, fbImageid:String ="" , itemId:String ="" ):void 
		{
			...
			_loader.contentLoaderInfo.addEventListener( IOErrorEvent.IO_ERROR, onLoadAssetError );
		}			
		...
		private function onLoadAssetComplete(e:Event):void 
		{
			...
			_assetLoaderEvent.obj.image = _loader.content;
			_assetLoaderEvent.obj.id = _itemId;
			_assetLoaderEvent.obj.url = _itemUrl;
		...
		private function onLoadAssetError(e:IOErrorEvent):void 
		{
			trace( "asset loaded is invalid path............................" );
			_assetLoaderEvent = new AssetLoaderEvent( AssetLoaderEvent.ASSET_LOAD_FAILED );
			dispatchEvent( _assetLoaderEvent );
		}
	}
