package com.surnia.socialStar.controllers 
{
	import flash.events.EventDispatcher;
	import flash.utils.Dictionary;
	/**
	 * ...
	 * @author monsterpatties dispatchESEvent
	 */
	public class EventSatellite extends EventDispatcher
	{
		...
		{			
			...
			if( !obj.found ){
				...
				//trace( event + "canot be added because its already added..........." ); addEvent(
			}
		}
		
		
		public function dispatchESEvent(  event:*, val:* = null ):void 
		{
			addEvent( event );
